...
ALTER TABLE note_nlp ADD CONSTRAINT fpk_note_nlp_note_id FOREIGN KEY (note_id) REFERENCES NOTE (NOTE_ID);
...
ALTER TABLE episode ADD CONSTRAINT fpk_episode_episode_parent_id FOREIGN KEY (episode_parent_id) REFERENCES EPISODE (EPISODE_ID);
